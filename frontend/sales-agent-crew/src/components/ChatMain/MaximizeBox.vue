<template>
  <div class="w-auto mx-2 h-[144px] p-2 rounded border border-[#C8E6C9] bg-[#FDEDD7] flex flex-col items-center justify-center space-y-2">
    ...
    <div class="flex items-center space-x-2">
      ...
      <p class="top-text">The Fastest in the Industry</p>
    </div>
